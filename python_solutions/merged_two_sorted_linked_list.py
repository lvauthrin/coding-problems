...
def main():
    test.validate(
        ...
        Solution().solve(linked_list.create(1, 2, 7, 8), linked_list.create(3, 4, 5, 6)),
    )
    test.validate(
        linked_list.create(3, 4, 5, 6), Solution().solve(linked_list.create(), linked_list.create(3, 4, 5, 6))
    )
    test.validate(
        linked_list.create(1, 2, 3, 4, 5, 6, 7, 8),
        Solution().solve(linked_list.create(1, 2, 3, 4), linked_list.create(5, 6, 7, 8)),
    )
