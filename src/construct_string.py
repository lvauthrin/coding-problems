...
def main():
  ...
  assert solution.construct_all('abcdef', ['ab','c','d','ef'], {}) == [['ab','c','d','ef']], "retuned number other than 1"
  assert solution.construct_all('abcdef', ['a', 'ab', 'bcd', 'cd','ef'], {}) == [['a', 'bcd', 'ef'], ['ab', 'cd', 'ef']], "retuned number other than 2"
